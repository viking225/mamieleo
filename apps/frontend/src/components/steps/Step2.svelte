...
<div class="w-full max-w-lg">
	<h2 class="mb-8 text-center text-3xl font-bold">Additional Details</h2>
	...
	<div class="flex flex-col gap-6">
		<div class="flex flex-col gap-2">
			...
			<input
				...
				type="text"
				bind:value={category}
				class="bg-background w-full rounded-lg border p-4 text-xl"
		...
		<div class="flex flex-col gap-2">
			...
			<div class="flex flex-col gap-4">
				{#each priorities as { value, label }}
					<label class="flex cursor-pointer items-center gap-3 text-xl">
